...
import com.flitsneak.goods.pojo.Para;
import com.flitsneak.goods.service.ParaService;
...
public class ParaController {
    ...
    public Result<List<Para>> getBycategoryId(@PathVariable Integer id){
        ...
        Result<List<Para>> result = new Result<>(true,StatusCode.OK,"查询对应品牌成功",paras);
        return result;
    }
}
