...
import com.flitsneak.goods.dao.SkuMapper;
import com.flitsneak.goods.dao.SpuMapper;
...
public class SpuServiceImpl implements SpuService {
    ...
    public int putMany(Long[] ids) {
        Spu spu=new Spu();
        spu.setIsMarketable("1");//上架
        //update tb_spu  set isMarketable = 1 whereid in ids and isDelete = 0 and status = 1;
        //批量修改
        Example example=new Example(Spu.class);
        Example.Criteria criteria = example.createCriteria();
        criteria.andIn("id", Arrays.asList(ids));//id 第二个参数必须是个集合所以要转换
        //下架
